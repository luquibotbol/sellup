...
export default function BuyListingPage({ params }: { params: { id: string } }) {
  return (
    <div>
      <Navbar />
      ...
      <div className="p-4">
        <h1 className="text-center mb-2">
          <span className="text-[#c1ff72] font-bold">buy</span>
        ...
        <div className="space-y-4">
          {mockSellers.map((seller) => (
            <div key={seller.id} className="bg-black rounded-lg p-4 text-white">
        ...
        <div className="mt-8">
          <Button className="w-full py-6 text-lg bg-black text-[#c1ff72] hover:bg-black/90">add to asks</Button>
        </div>
      </div>
    </div>
  )
